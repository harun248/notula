...
//                String myFormat = "dd MMMM yyyy";
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(AddMeetingsActivity.this, date,
...
//Time Picker
        ...
        txtStartTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(AddMeetingsActivity.this, new TimePickerDialog.OnTimeSetListener() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Constant.CREATE_MEETINGS, response -> {
            ...
            try {
                ...
                if (object.getBoolean("success")) {
                    ...
                    MeetingsFragment.arrayList.add(0, meetings);
...
//                map.put("position",txtName.getText().toString().trim());
        ...
        RequestQueue queue = Volley.newRequestQueue(AddMeetingsActivity.this);
        queue.add(request);
